...
function init() {
    ...
    // Blue Cube
    const cube2Geometry = new THREE.BoxGeometry(0.4, 0.4, 0.4);
    ...
    const blueCube = new THREE.Mesh(cube2Geometry, cube2Material);
    blueCube.castShadow = true;
    blueCube.receiveShadow = true;
    blueCube.position.set(1, 1, -3);  // Adjust the position as needed
    scene.add(blueCube);
